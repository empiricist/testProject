...
*/
    ...
    private static void loadConfiguration(){
        ...
        vanillaRecipes = configuration.getBoolean("vanillaRecipes", Configuration.CATEGORY_GENERAL, false, "Enable recipes using Minecraft items");
        ...
        ic2Recipes = configuration.getBoolean("ic2Recipes", Configuration.CATEGORY_GENERAL, false, "Enable recipes using IndustrialCraft 2 items");
